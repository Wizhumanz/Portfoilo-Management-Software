...
const Loans = () => {
    return (
        <section id="Loans" className="container-fluid section-top-padding">
            <div className="row">
                <div className="col-12">
                    <div className="card">
                        ...
                        <div className="card-header">
                            <h5 className="card-title mb-0">Loans</h5>
                        </div>
                        <div className="card-body">
                            <p className="form-group">You haven't added your first Loan to this Property yet. Get started by <a href="#"><span className="text-primary">adding one now</span></a></p>
